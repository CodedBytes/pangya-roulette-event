...
const ItemModal = ({img, itemName, OpenModal, CloseModal, open, setOpen}) => {
        ...
        <Fade in={open}>
          <Box sx={style}>
            ...
            <Typography id="transition-modal-description" sx={{ mt: 2 }}>
                ...
                <span>Você ganhou o seguinte item: {itemName}</span><br />
                <span>Seu item será enviado para o Mail de seu jogo em instantes.</span>
            </Typography>
          </Box>
        </Fade>
      </Modal>
